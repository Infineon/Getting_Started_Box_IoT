...
### ESP32 MH-ET LIVE MiniKIT in WEMOS D1 Mini form-factor
<a name="ESP32"></a>
...
## Shield2Go Boards: Quick start with the XMC 2Go

For a quick start with the Shield2Go boards and the XMC 2Go you need to install the library for the respective Shield2Go board either with the built-in **Library Manager** of the Arduino IDE or directly from **github**. All those steps are descriped for each Shield2Go board individually in this section.
...
For easy evaluation you can also stack our magnetic knob or joystick on the 3D Magnetic Shield2Go.
